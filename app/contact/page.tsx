            ...
            <section className="relative py-20">
                <div className="container mx-auto px-6">
                    <div className="glass-card p-8 sm:p-12 md:p-20 rounded-[2.5rem] sm:rounded-[3rem] border-primary/20 text-center relative overflow-hidden group mx-4 md:mx-0" data-aos="zoom-in">
                        ...
                        <Button asChild className="w-full sm:w-auto px-12 py-8 text-lg sm:text-xl font-display font-black uppercase tracking-widest bg-primary text-primary-foreground hover:bg-foreground hover:text-background transition-all rounded-full shadow-[0_0_30px_rgba(var(--primary-rgb),0.3)]">
                            <Link href="/custom-request">REQUEST CUSTOM QUOTATION</Link>
                        </Button>
                    </div>
                </div>
            </section>
