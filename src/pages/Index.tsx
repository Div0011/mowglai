  ...
  return (
    <PageLayout>
      <SEO
        ...
        description="Mowglai is a premier digital agency specializing in high-end web and mobile application development. We craft digital experiences that define the future."
