    ...
    return (
        <PageLayout>
            <SEO
                ...
                description="Tell us your vision. Mowglai creates custom digital solutions for your business needs. Share your idea and get a tailored proposal."
            />
            <section className="relative min-h-screen py-16">
                <div className="container mx-auto px-6">
                    ...
                    {/* Business Idea Preview (shown in step 2) */}
                    {step === 2 && (
                        <div className="max-w-4xl mx-auto mt-8" data-aos="fade-up" data-aos-delay="200">
                            <div className="glass-card rounded-2xl p-6 border-primary/20 bg-primary/5">
                                <p className="text-sm font-display uppercase tracking-wider text-primary mb-2">Your Business Idea:</p>
                                <p className="text-muted-foreground italic">{formData.businessIdea}</p>
                            </div>
                        </div>
                    )}
                </div>
